-- question 1   what is the total revenue generated  by sale by males ve female customer ..?

SELECT gender , SUM(purchase_amount) AS revenue
FROM customer_data
GROUP BY gender ;
  -- which customer use discount  but still spent more then average  purchase amount ...?
